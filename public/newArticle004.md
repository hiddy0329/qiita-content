...
tags:
  ...
  - エンジニア
private: false
updated_at: '2025-04-10T09:58:22+09:00'
...
その学習内容を備忘録として発信します。
前回「**変数**」に関する記事を投稿しましたが、今回はその中でも**変数についての「値渡し」と「参照渡し」と「参照の値渡し」**という部分についてです。

# 2. 話の進め方

プログラミングにおいて「変数の扱い方」は非常に重要な概念です。
プログラムがデータを扱う際、言語ごとにどのような変数の扱い方をするかによってパフォーマンスなどに影響が出てきますので理解しておくことは重要です。
まず、「**どういうものか**」について説明し、その後「**言語ごとにどう違うのか**」という順番で解説を進めます。
